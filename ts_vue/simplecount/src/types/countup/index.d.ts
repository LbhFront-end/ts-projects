...
declare class CountUp {
    constructor(target: string, startVal: number, endVal: number, decimals: number, duration: number, options: any);
    public options: CountUpOptions;
    public version(): string;
    public printValue(value: any): void;
    public count(timestamp: any): void;
